...
use DFSClientV3\Entity\Custom\BingoEntityMainTasks;

class BingoEntityMain extends \DFSClientV3\Models\ResponseModel 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|BingoEntityMainTasks[] tasks;
    */
    public $tasks = null;        
     

	/**
	* @return \DFSClientV3\Entity\Custom\BingoEntityMainTasksResult|null
	*/
	public function getResultsByPostID($postID): ?\DFSClientV3\Entity\Custom\BingoEntityMainTasksResult {
