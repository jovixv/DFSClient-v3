...
use DFSClientV3\Entity\Custom\KeywordsForKeywordSetTaskEntityMain;
use DFSClientV3\Models\AbstractModel;

class KeywordsForKeywordSetTask extends AbstractModel
{
    ...
    protected $requestToFunction = 'keywords_data/{$se}/keywords_for_keywords/task_post';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return KeywordsForKeywordSetTaskEntityMain
     */
    #[\Override]
    public function get(): KeywordsForKeywordSetTaskEntityMain
    {
        return parent::get();
    }
