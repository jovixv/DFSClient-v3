...
use DFSClientV3\Entity\Custom\KeywordsForSiteSetTaskEntityMain;
...
class KeywordsForSiteSetTask extends AbstractModel
{
    ...
    /**
     * @return KeywordsForSiteSetTaskEntityMain
     */
    #[\Override]
    public function get(): KeywordsForSiteSetTaskEntityMain
    {
        return parent::get();
    }
