...
use DFSClientV3\Entity\Custom\BingAdsSearchVolumeLiveEntityMain;
use DFSClientV3\Models\AbstractModel;

class BingAdsSearchVolumeLive extends AbstractModel
{
    protected $method = 'POST';
    protected $isSupportedMerge = true;
    protected $pathToMainData = 'tasks->{$postID}->result';
    protected $requestToFunction = 'keywords_data/bing/search_volume/live';
    ...
    /**
     * @return BingAdsSearchVolumeLiveEntityMain
     */
    public function get(): BingAdsSearchVolumeLiveEntityMain
    {
        return parent::get();
    }
