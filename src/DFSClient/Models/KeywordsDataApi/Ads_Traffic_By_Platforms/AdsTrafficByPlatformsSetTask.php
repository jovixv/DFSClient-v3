...
use DFSClientV3\Entity\Custom\AdsTrafficByPlatformsSetTaskEntityMain;
...
class AdsTrafficByPlatformsSetTask extends AbstractModel
{
    ...
    protected $requestToFunction = 'keywords_data/{$se}/ad_traffic_by_platforms/task_post';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return AdsTrafficByPlatformsSetTaskEntityMain
     */
    #[\Override]
    public function get(): AdsTrafficByPlatformsSetTaskEntityMain
    {
        return parent::get();
    }
