...
use DFSClientV3\Entity\Custom\SettingSerpLiveRegularEntityMain;
...
class SettingSerpLiveRegular extends AbstractModel
{
    ...
    /**
     * @return SettingSerpLiveRegularEntityMain
     */
    #[\Override]
    public function get(): SettingSerpLiveRegularEntityMain
    {
        return parent::get();
    }
