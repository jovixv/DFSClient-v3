...
use DFSClientV3\Entity\Custom\GoogleProductSpecSetTaskEntityMain;
use DFSClientV3\Models\AbstractModel;

class GoogleProductSpecSetTask extends AbstractModel
{
    ...
    protected $requestToFunction = 'merchant/google/product_spec/task_post';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return \DFSClientV3\Entity\Custom\GoogleProductSpecSetTaskEntityMain
     */
    #[\Override]
    public function get(): GoogleProductSpecSetTaskEntityMain
    {
        return parent::get();
    }
