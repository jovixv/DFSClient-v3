...
class AmazonAsinLiveAdvanced extends AbstractModel
{
    protected $method = 'POST';
    protected $isSupportedMerge = true;
    protected $pathToMainData = 'tasks->{$postID}->result';
    protected $requestToFunction = 'merchant/amazon/asin/live/advanced';
    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return \DFSClientV3\Entity\Custom\AmazonAsinLiveAdvancedEntityMain
     */
    public function get(): \DFSClientV3\Entity\Custom\AmazonAsinLiveAdvancedEntityMain
    {
        return parent::get();
    }
