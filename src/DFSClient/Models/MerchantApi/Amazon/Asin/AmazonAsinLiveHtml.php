...
class AmazonAsinLiveHtml extends AbstractModel
{
    protected $method = 'POST';
    protected $isSupportedMerge = true;
    protected $pathToMainData = 'tasks->{$postID}->result';
    protected $requestToFunction = 'merchant/amazon/asin/live/html';
    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return \DFSClientV3\Entity\Custom\AmazonAsinLiveHtmlEntityMain
     */
    public function get(): \DFSClientV3\Entity\Custom\AmazonAsinLiveHtmlEntityMain
    {
        return parent::get();
    }
