...
class AmazonProductsLiveAdvanced extends AbstractModel
{
    protected $method = 'POST';
    protected $isSupportedMerge = true;
    protected $pathToMainData = 'tasks->{$postID}->result';
    protected $requestToFunction = 'merchant/amazon/products/live/advanced';
    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return \DFSClientV3\Entity\Custom\AmazonProductsLiveAdvancedEntityMain
     */
    public function get(): \DFSClientV3\Entity\Custom\AmazonProductsLiveAdvancedEntityMain
    {
        return parent::get();
    }
