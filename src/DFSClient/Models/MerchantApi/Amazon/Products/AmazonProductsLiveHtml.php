...
class AmazonProductsLiveHtml extends AbstractModel
{
    protected $method = 'POST';
    protected $isSupportedMerge = true;
    protected $pathToMainData = 'tasks->{$postID}->result';
    protected $requestToFunction = 'merchant/amazon/products/live/html';
    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return \DFSClientV3\Entity\Custom\AmazonProductsLiveHtmlEntityMain
     */
    public function get(): \DFSClientV3\Entity\Custom\AmazonProductsLiveHtmlEntityMain
    {
        return parent::get();
    }
