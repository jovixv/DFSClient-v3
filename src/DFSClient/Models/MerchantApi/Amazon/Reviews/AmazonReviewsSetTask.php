...
use DFSClientV3\Entity\Custom\AmazonReviewsSetTaskEntityMain;
use DFSClientV3\Models\AbstractModel;

class AmazonReviewsSetTask extends AbstractModel
{
    ...
    protected $requestToFunction = 'merchant/amazon/reviews/task_post';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return AmazonReviewsSetTaskEntityMain
     */
    #[\Override]
    public function get(): AmazonReviewsSetTaskEntityMain
    {
        return parent::get();
    }
