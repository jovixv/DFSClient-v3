...
class AmazonSellersLiveHtml extends AbstractModel
{
    protected $method = 'POST';
    protected $isSupportedMerge = true;
    protected $pathToMainData = 'tasks->{$postID}->result';
    protected $requestToFunction = 'merchant/amazon/sellers/live/html';
    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return \DFSClientV3\Entity\Custom\AmazonSellersLiveHtmlEntityMain
     */
    public function get(): \DFSClientV3\Entity\Custom\AmazonSellersLiveHtmlEntityMain
    {
        return parent::get();
    }
