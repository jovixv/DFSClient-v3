...
use DFSClientV3\Entity\Custom\AppleAppInfoSetTaskEntityMain;
use DFSClientV3\Models\AbstractModel;

class AppleAppInfoSetTask extends AbstractModel
{
    ...
    protected $requestToFunction = 'app_data/apple/app_info/task_post';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return AppleAppInfoSetTaskEntityMain
     */
    #[\Override]
    public function get(): AppleAppInfoSetTaskEntityMain
    {
        return parent::get();
    }
