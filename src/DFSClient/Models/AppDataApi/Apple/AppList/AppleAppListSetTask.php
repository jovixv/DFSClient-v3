...
use DFSClientV3\Entity\Custom\AppleAppListSetTaskEntityMain;
use DFSClientV3\Models\AbstractModel;

class AppleAppListSetTask extends AbstractModel
{
    ...
    protected $requestToFunction = 'app_data/apple/app_list/task_post';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return AppleAppListSetTaskEntityMain
     */
    #[\Override]
    public function get(): AppleAppListSetTaskEntityMain
    {
        return parent::get();
    }
