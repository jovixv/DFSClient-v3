...
use DFSClientV3\Entity\Custom\GoogleAppListingsSearchLiveEntityMain;
use DFSClientV3\Models\AbstractModel;

class GoogleAppListingsSearchLive extends AbstractModel
{
    ...
    protected $requestToFunction = 'app_data/google/app_listings/search/live';
