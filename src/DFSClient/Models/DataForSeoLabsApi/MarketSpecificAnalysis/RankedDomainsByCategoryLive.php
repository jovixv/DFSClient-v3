...
class RankedDomainsByCategoryLive extends AbstractModel
{
    protected $method = 'POST';
    protected $isSupportedMerge = true;
    protected $pathToMainData = 'tasks->{$postID}->result';
    protected $requestToFunction = 'dataforseo_labs/ranked_domains_by_category/live';
    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return \DFSClientV3\Entity\Custom\RankedDomainsByCategoryLiveEntityMain
     */
    public function get(): \DFSClientV3\Entity\Custom\RankedDomainsByCategoryLiveEntityMain
    {
        return parent::get();
    }
