...
use DFSClientV3\Entity\Custom\RelevantPagesLiveEntityMain;
use DFSClientV3\Models\AbstractModel;

class RelevantPagesLive extends AbstractModel
{
    ...
    protected $requestToFunction = 'dataforseo_labs/relevant_pages/live';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return RelevantPagesLiveEntityMain
     */
    #[\Override]
    public function get(): RelevantPagesLiveEntityMain
    {
        return parent::get();
    }
