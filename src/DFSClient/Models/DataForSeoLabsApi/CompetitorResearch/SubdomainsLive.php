...
use DFSClientV3\Entity\Custom\SubdomainsLiveEntityMain;
use DFSClientV3\Models\AbstractModel;

class SubdomainsLive extends AbstractModel
{
    ...
    protected $requestToFunction = 'dataforseo_labs/subdomains/live';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return SubdomainsLiveEntityMain
     */
    #[\Override]
    public function get(): SubdomainsLiveEntityMain
    {
        return parent::get();
    }
