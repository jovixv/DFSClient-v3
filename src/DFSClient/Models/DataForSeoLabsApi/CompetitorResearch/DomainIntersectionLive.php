...
use DFSClientV3\Entity\Custom\DomainIntersectionLiveEntityMain;
use DFSClientV3\Models\AbstractModel;

class DomainIntersectionLive extends AbstractModel
{
    ...
    protected $requestToFunction = 'dataforseo_labs/domain_intersection/live';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return DomainIntersectionLiveEntityMain
     */
    #[\Override]
    public function get(): DomainIntersectionLiveEntityMain
    {
        return parent::get();
    }
