...
use DFSClientV3\Entity\Custom\CompetitorsDomainLiveEntityMain;
use DFSClientV3\Models\AbstractModel;

class CompetitorsDomainLive extends AbstractModel
{
    ...
    protected $requestToFunction = 'dataforseo_labs/competitors_domain/live';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return CompetitorsDomainLiveEntityMain
     */
    #[\Override]
    public function get(): CompetitorsDomainLiveEntityMain
    {
        return parent::get();
    }
