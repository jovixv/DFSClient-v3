...
class GoogleKeywordOverviewLive extends AbstractModel
{
    protected $method = 'POST';
    protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'dataforseo_labs/google/keyword_overview/live';
	protected $resultShouldBeTransformedToArray = true;
	protected $useNewMapper = true;

    /**
     * @return \DFSClientV3\Entity\Custom\GoogleKeywordOverviewLiveEntityMain
     */
    public function get(): \DFSClientV3\Entity\Custom\GoogleKeywordOverviewLiveEntityMain
    {
        return parent::get();
    }
