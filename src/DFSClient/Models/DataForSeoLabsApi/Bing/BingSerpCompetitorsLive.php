...
use DFSClientV3\Entity\Custom\BingSerpCompetitorsLiveEntityMain;
use DFSClientV3\Models\AbstractModel;

class BingSerpCompetitorsLive extends AbstractModel
{
    ...
    protected $requestToFunction = 'dataforseo_labs/bing/serp_competitors/live';

    protected $resultShouldBeTransformedToArray = true;

    /**
     * @return \DFSClientV3\Entity\Custom\BingSerpCompetitorsLiveEntityMain
     */
    #[\Override]
    public function get(): BingSerpCompetitorsLiveEntityMain
    {
        return parent::get();
    }
