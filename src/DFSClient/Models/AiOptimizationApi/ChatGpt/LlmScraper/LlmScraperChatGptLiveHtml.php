...
class LlmScraperChatGptLiveHtml extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/chat_gpt/llm_scraper/live/html';
	protected $resultShouldBeTransformedToArray = true;

	/**
	 * @return \DFSClientV3\Entity\Custom\LlmScraperChatGptLiveHtmlEntityMain
	 */
	public function get(): \DFSClientV3\Entity\Custom\LlmScraperChatGptLiveHtmlEntityMain {
		return parent::get();
	}
