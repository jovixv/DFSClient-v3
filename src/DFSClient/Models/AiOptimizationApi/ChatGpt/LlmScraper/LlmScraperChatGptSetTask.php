...
class LlmScraperChatGptSetTask extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/chat_gpt/llm_scraper/task_post';
	protected $resultShouldBeTransformedToArray = true;

	/**
	 * @return \DFSClientV3\Entity\Custom\LlmScraperChatGptSetTaskEntityMain
	 */
	public function get(): \DFSClientV3\Entity\Custom\LlmScraperChatGptSetTaskEntityMain {
		return parent::get();
	}
