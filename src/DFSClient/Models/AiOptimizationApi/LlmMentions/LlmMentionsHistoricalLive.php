...
class LlmMentionsHistoricalLive extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/llm_mentions/historical/live';
	...
	public function get(): \DFSClientV3\Entity\Custom\LlmMentionsHistoricalLiveEntityMain {
		return parent::get();
	}
}
