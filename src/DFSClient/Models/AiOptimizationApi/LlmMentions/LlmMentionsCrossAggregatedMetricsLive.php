...
/**
 * @deprecated Use LlmMentionsMultiTargetMetricsLive.
 */
class LlmMentionsCrossAggregatedMetricsLive extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/llm_mentions/cross_aggregated_metrics/live';
	...
	/**
	 * @return \DFSClientV3\Entity\Custom\LlmMentionsCrossAggregatedMetricsLiveEntityMain
	 */
	public function get(): \DFSClientV3\Entity\Custom\LlmMentionsCrossAggregatedMetricsLiveEntityMain {
		return parent::get();
	}
}
