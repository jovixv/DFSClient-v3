...
class LlmMentionsTopMentionedPagesLiteLive extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/llm_mentions/top_mentioned_pages_lite/live';
	...
	public function setIncludePages(array $includePages) {
		$this->payload['include_pages'] = $includePages;
		return $this;
	}
	...
	public function get(): \DFSClientV3\Entity\Custom\LlmMentionsTopMentionedPagesLiteLiveEntityMain {
		return parent::get();
	}
}
