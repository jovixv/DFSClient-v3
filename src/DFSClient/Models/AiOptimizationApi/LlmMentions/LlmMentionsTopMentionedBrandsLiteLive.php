...
class LlmMentionsTopMentionedBrandsLiteLive extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/llm_mentions/top_mentioned_brands_lite/live';
	...
	public function get(): \DFSClientV3\Entity\Custom\LlmMentionsTopMentionedBrandsLiteLiveEntityMain {
		return parent::get();
	}
}
