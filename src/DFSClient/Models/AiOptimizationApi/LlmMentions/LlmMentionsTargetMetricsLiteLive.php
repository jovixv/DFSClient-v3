...
class LlmMentionsTargetMetricsLiteLive extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/llm_mentions/target_metrics_lite/live';
	...
	public function get(): \DFSClientV3\Entity\Custom\LlmMentionsTargetMetricsLiteLiveEntityMain {
		return parent::get();
	}
}
