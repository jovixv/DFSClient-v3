...
class LlmMentionsTimeseriesDeltaLive extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/llm_mentions/timeseries_delta/live';
	...
	public function get(): \DFSClientV3\Entity\Custom\LlmMentionsTimeseriesDeltaLiveEntityMain {
		return parent::get();
	}
}
