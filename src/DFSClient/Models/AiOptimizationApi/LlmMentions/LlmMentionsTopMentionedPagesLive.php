...
class LlmMentionsTopMentionedPagesLive extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/llm_mentions/top_mentioned_pages/live';
	...
	public function get(): \DFSClientV3\Entity\Custom\LlmMentionsTopMentionedPagesLiveEntityMain {
		return parent::get();
	}
}
