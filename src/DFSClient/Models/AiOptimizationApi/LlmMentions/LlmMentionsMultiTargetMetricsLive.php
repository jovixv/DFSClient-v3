...
class LlmMentionsMultiTargetMetricsLive extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/llm_mentions/multi_target_metrics/live';
	...
	public function get(): \DFSClientV3\Entity\Custom\LlmMentionsMultiTargetMetricsLiveEntityMain {
		return parent::get();
	}
}
