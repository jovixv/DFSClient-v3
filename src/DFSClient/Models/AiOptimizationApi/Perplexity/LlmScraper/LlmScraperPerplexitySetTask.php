...
class LlmScraperPerplexitySetTask extends AbstractModel {
	protected $method = 'POST';
	protected $isSupportedMerge = true;
	protected $pathToMainData = 'tasks->{$postID}->result';
	protected $requestToFunction = 'ai_optimization/perplexity/llm_scraper/task_post';
	protected $resultShouldBeTransformedToArray = true;

	/**
	 * @return \DFSClientV3\Entity\Custom\LlmScraperPerplexitySetTaskEntityMain
	 */
	public function get(): \DFSClientV3\Entity\Custom\LlmScraperPerplexitySetTaskEntityMain {
		return parent::get();
	}
