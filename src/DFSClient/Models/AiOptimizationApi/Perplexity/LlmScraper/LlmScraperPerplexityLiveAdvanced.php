...
class LlmScraperPerplexityLiveAdvanced extends AbstractModel {
	...
	protected $requestToFunction = 'ai_optimization/perplexity/llm_scraper/live/advanced';
	protected $resultShouldBeTransformedToArray = true;

	/**
	 * @return \DFSClientV3\Entity\Custom\LlmScraperPerplexityLiveAdvancedEntityMain
	 */
	public function get(): \DFSClientV3\Entity\Custom\LlmScraperPerplexityLiveAdvancedEntityMain {
		return parent::get();
	}
