...
abstract class AbstractModel
{
    ...
    protected $seTypes = ['organic', 'maps', 'local_pack', 'news', 'images', 'search_by_image', 'events', 'jobs', 'local_finder', 'video_info', 'video_subtitles', 'video_comments', 'dataset_search', 'dataset_info', 'autocomplete', 'ads_advertisers', 'ads_search'];
