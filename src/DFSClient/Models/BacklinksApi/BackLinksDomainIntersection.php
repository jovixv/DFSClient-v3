...
use DFSClientV3\Entity\Custom\BackLinksDomainIntersectionEntityMain;
use DFSClientV3\Models\AbstractModel;
use DFSClientV3\Models\BacklinksApi\Dictionaries\DomainIntersectionDictionary;

class BackLinksDomainIntersection extends AbstractModel
{
    ...
    protected $requestToFunction = 'backlinks/domain_intersection/live';
    ...
    public function initCustomFunctionForPaths(): array
    {
        return [
            ...
            'tasks->(:number)->result->(:number)->items'   => fn ($key, $value) => json_decode(json_encode($value), true),
        ];
    }

    #[\Override]
    public function get(): BackLinksDomainIntersectionEntityMain
    {
