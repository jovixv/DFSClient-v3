...
{    
    /**
    * @var array|BusinessListingsSearchLiveEntityMainTasksResultItemsWork_timeWork_hoursTimetableSunday[] $sunday;
    */
    public $sunday = [];

    /**
    * @var array|BusinessListingsSearchLiveEntityMainTasksResultItemsWork_timeWork_hoursTimetableMonday[] $monday;
    */
    public $monday = [];

    /**
    * @var array|BusinessListingsSearchLiveEntityMainTasksResultItemsWork_timeWork_hoursTimetableTuesday[] $tuesday;
    */
    public $tuesday = [];

    /**
    * @var array|BusinessListingsSearchLiveEntityMainTasksResultItemsWork_timeWork_hoursTimetableWednesday[] $wednesday;
    */
    public $wednesday = [];

    /**
    * @var array|BusinessListingsSearchLiveEntityMainTasksResultItemsWork_timeWork_hoursTimetableThursday[] $thursday;
    */
    public $thursday = [];

    /**
    * @var array|BusinessListingsSearchLiveEntityMainTasksResultItemsWork_timeWork_hoursTimetableFriday[] $friday;
    */
    public $friday = [];

    /**
    * @var array|BusinessListingsSearchLiveEntityMainTasksResultItemsWork_timeWork_hoursTimetableSaturday[] $saturday;
    */
    public $saturday = [];
