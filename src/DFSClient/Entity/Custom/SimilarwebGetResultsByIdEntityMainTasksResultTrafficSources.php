...
{    
    /**
    * @var null|SimilarwebGetResultsByIdEntityMainTasksResultTrafficSourcesDirect $direct;
    */
    public $direct = null;

    /**
    * @var null|SimilarwebGetResultsByIdEntityMainTasksResultTrafficSourcesSearch_organic $search_organic;
    */
    public $search_organic = null;

    /**
    * @var null|SimilarwebGetResultsByIdEntityMainTasksResultTrafficSourcesSearch_ad $search_ad;
    */
    public $search_ad = null;

    /**
    * @var null|SimilarwebGetResultsByIdEntityMainTasksResultTrafficSourcesReferring $referring;
    */
    public $referring = null;

    /**
    * @var null|SimilarwebGetResultsByIdEntityMainTasksResultTrafficSourcesReferral_destination $referral_destination;
    */
    public $referral_destination = null;

    /**
    * @var null|SimilarwebGetResultsByIdEntityMainTasksResultTrafficSourcesSocial $social;
    */
    public $social = null;

    /**
    * @var null|SimilarwebGetResultsByIdEntityMainTasksResultTrafficSourcesDisplay_ad $display_ad;
    */
    public $display_ad = null;

    /**
    * @var null|SimilarwebGetResultsByIdEntityMainTasksResultTrafficSourcesMobile_apps $mobile_apps;
    */
    public $mobile_apps = null;

    /**
    * @var null|SimilarwebGetResultsByIdEntityMainTasksResultTrafficSourcesMail $mail;
    */
    public $mail = null;
