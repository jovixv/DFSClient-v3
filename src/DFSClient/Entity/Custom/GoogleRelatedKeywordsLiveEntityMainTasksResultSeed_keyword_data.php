...
{    
    ...
    */
    ...
    /**
    * @var null|GoogleRelatedKeywordsLiveEntityMainTasksResultSeed_keyword_dataKeyword_info_normalized_with_bing $keyword_info_normalized_with_bing;
    */
    public $keyword_info_normalized_with_bing = null;

    /**
    * @var null|GoogleRelatedKeywordsLiveEntityMainTasksResultSeed_keyword_dataKeyword_info_normalized_with_clickstream $keyword_info_normalized_with_clickstream;
    */
    ...
    */
    ...
    /**
    * @var null|GoogleRelatedKeywordsLiveEntityMainTasksResultSeed_keyword_dataSerp_info $serp_info;
    */
    public $serp_info = null;

    /**
    * @var null|GoogleRelatedKeywordsLiveEntityMainTasksResultSeed_keyword_dataKeyword_properties $keyword_properties;
    */
    public $keyword_properties = null;

    /**
    * @var null|GoogleRelatedKeywordsLiveEntityMainTasksResultSeed_keyword_dataAvg_backlinks_info $avg_backlinks_info;
    */
    public $avg_backlinks_info = null;

    /**
    * @var null|GoogleRelatedKeywordsLiveEntityMainTasksResultSeed_keyword_dataSearch_intent_info $search_intent_info;
    */
