...
use DFSClient\Entity\Custom\GetSerpHtmlResultsByTaskIdEntityTasks;

class GetSerpHtmlResultsByTaskIdEntityMain extends \DFSClient\Models\ResponseModel 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|GetSerpHtmlResultsByTaskIdEntityTasks[] tasks;
    */
    public $tasks = null;        
     

	/**
	* @return \DFSClient\Entity\Custom\GetSerpHtmlResultsByTaskIdEntityResult[]|null
	*/
