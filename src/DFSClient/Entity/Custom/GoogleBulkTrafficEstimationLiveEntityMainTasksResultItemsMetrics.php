...
{    
    /**
    * @var null|GoogleBulkTrafficEstimationLiveEntityMainTasksResultItemsMetricsOrganic $organic;
    */
    public $organic = null;

    /**
    * @var null|GoogleBulkTrafficEstimationLiveEntityMainTasksResultItemsMetricsPaid $paid;
    */
    public $paid = null;

    /**
    * @var null|GoogleBulkTrafficEstimationLiveEntityMainTasksResultItemsMetricsLocal_pack $local_pack;
    */
    public $local_pack = null;

    /**
    * @var null|GoogleBulkTrafficEstimationLiveEntityMainTasksResultItemsMetricsFeatured_snippet $featured_snippet;
    */
