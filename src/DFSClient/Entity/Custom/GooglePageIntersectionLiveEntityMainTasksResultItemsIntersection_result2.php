...
{    
    ...
    */
    ...
    /**
    * @var null|GooglePageIntersectionLiveEntityMainTasksResultItemsIntersection_result2Backlinks_info $backlinks_info;
    */
    public $backlinks_info = null;

    /**
    * @var null|GooglePageIntersectionLiveEntityMainTasksResultItemsIntersection_result2Rank_info $rank_info;
    */
