...
{    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderLiveRelated_keywordsPriority_low priority_low;
    */
    public $priority_low = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderLiveRelated_keywordsPriority_normal priority_normal;
    */
    public $priority_normal = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderLiveRelated_keywordsPriority_high priority_high;
    */
