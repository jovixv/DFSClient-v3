...
use DFSClient\Entity\Custom\SettingSerpTasksEntityTasks;

class SettingSerpTasksEntityMain extends \DFSClient\Models\ResponseModel 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|SettingSerpTasksEntityTasks[] tasks;
    */
    public $tasks = null;        
