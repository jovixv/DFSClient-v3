...
use DFSClientV3\Entity\Custom\OnPageGetResourcesEntityMainTasksResultItemsStylesheetChecks;

class OnPageGetResourcesEntityMainTasksResultItemsStylesheet 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|OnPageGetResourcesEntityMainTasksResultItemsStylesheetFetch_timing $fetch_timing;
    */
    public $fetch_timing = null;

    /**
    * @var null|OnPageGetResourcesEntityMainTasksResultItemsStylesheetCache_control $cache_control;
    */
    public $cache_control = null;

    /**
    * @var null|OnPageGetResourcesEntityMainTasksResultItemsStylesheetChecks $checks;
    */
    public $checks = null;
