...
use DFSClientV3\Entity\Custom\GoogleRankedKeywordsLiveEntityMainTasksResultMetricsOrganicClickstream_gender_distribution;
use DFSClientV3\Entity\Custom\GoogleRankedKeywordsLiveEntityMainTasksResultMetricsOrganicClickstream_age_distribution;

class GoogleRankedKeywordsLiveEntityMainTasksResultMetricsOrganic 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultMetricsOrganicClickstream_gender_distribution $clickstream_gender_distribution;
    */
    public $clickstream_gender_distribution = null;

    /**
    * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultMetricsOrganicClickstream_age_distribution $clickstream_age_distribution;
    */
