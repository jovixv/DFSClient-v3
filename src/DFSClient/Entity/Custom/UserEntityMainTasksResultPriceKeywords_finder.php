...
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_finderCategories_for_domain;
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_finderCompetitors_domain;
...
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_finderRelevant_pages;
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_finderSerp_competitors;
...
{    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderCategories_for_domain categories_for_domain;
    */
    public $categories_for_domain = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderCompetitors_domain competitors_domain;
    */
    public $competitors_domain = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderDomain_intersection domain_intersection;
    */
    public $domain_intersection = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderKeywords_for_categories keywords_for_categories;
    */
    ...
    */
    ...
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderRanked_keywords ranked_keywords;
    */
    public $ranked_keywords = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderRelated_keywords related_keywords;
    */
    public $related_keywords = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderRelevant_pages relevant_pages;
    */
    public $relevant_pages = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderSerp_competitors serp_competitors;
    */
    public $serp_competitors = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderSimilar_keywords similar_keywords;
    */
    public $similar_keywords = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_finderSubdomains subdomains;
    */
