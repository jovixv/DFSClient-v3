...
use DFSClientV3\Entity\Custom\GooglePageIntersectionLiveEntityMainTasksResultItemsIntersection_result1Rank_changes;
use DFSClientV3\Entity\Custom\GooglePageIntersectionLiveEntityMainTasksResultItemsIntersection_result1Backlinks_info;
use DFSClientV3\Entity\Custom\GooglePageIntersectionLiveEntityMainTasksResultItemsIntersection_result1Rank_info;

#[\AllowDynamicProperties]
class GooglePageIntersectionLiveEntityMainTasksResultItemsIntersection_result1 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|GooglePageIntersectionLiveEntityMainTasksResultItemsIntersection_result1Rank_changes $rank_changes;
    */
    public $rank_changes = null;

    /**
    * @var null|GooglePageIntersectionLiveEntityMainTasksResultItemsIntersection_result1Backlinks_info $backlinks_info;
    */
    public $backlinks_info = null;

    /**
    * @var null|GooglePageIntersectionLiveEntityMainTasksResultItemsIntersection_result1Rank_info $rank_info;
    */
