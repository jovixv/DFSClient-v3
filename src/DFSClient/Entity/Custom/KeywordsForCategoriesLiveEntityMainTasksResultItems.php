...
{    
    ...
    */
    ...
    /**
    * @var null|KeywordsForCategoriesLiveEntityMainTasksResultItemsKeyword_info $keyword_info;
    */
    public $keyword_info = null;

    /**
    * @var null|KeywordsForCategoriesLiveEntityMainTasksResultItemsImpressions_info $impressions_info;
    */
