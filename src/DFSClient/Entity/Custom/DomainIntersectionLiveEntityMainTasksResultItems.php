...
{
    /**
     * @var null|DomainIntersectionLiveEntityMainTasksResultItemsKeyword_data;
     */
    public $keyword_data = null;

    /**
     * @var null|DomainIntersectionLiveEntityMainTasksResultItemsFirst_domain_serp_element;
     */
    public $first_domain_serp_element = null;

    /**
     * @var null|DomainIntersectionLiveEntityMainTasksResultItemsSecond_domain_serp_element;
     */
