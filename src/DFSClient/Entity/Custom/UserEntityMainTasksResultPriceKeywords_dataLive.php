...
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_dataLiveAd_traffic_by_keywords;
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_dataLiveAd_traffic_by_platforms;
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_dataLiveKeywords_for_category;
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_dataLiveKeywords_for_keywords;
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_dataLiveKeywords_for_site;
use DFSClientV3\Entity\Custom\UserEntityMainTasksResultPriceKeywords_dataLiveSearch_volume;
