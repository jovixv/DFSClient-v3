...
{    
    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultRelated_keywordsGoogle $google;
    */
    public $google = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultRelated_keywordsBing $bing;
    */
    public $bing = null;
