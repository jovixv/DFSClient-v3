...
{    
    ...
    */
    ...
    /**
    * @var array|SearchVolumeHistoryGetCompletedTasksEntityMainTasks[] $tasks;
    */
    public $tasks = [];
 

	/**
	* @return \DFSClientV3\Entity\Custom\SearchVolumeHistoryGetCompletedTasksEntityMainTasksResult[]|null
	*/
