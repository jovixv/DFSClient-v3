...
{    
    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultCompetitors_domainGoogle $google;
    */
    public $google = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultCompetitors_domainBing $bing;
    */
    public $bing = null;
