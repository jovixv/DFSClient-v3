...
{    
    /**
    * @var null|BusinessListingsSearchLiveEntityMainTasksResultItemsWork_timeWork_hoursTimetableThursdayOpen $open;
    */
    public $open = null;

    /**
    * @var null|BusinessListingsSearchLiveEntityMainTasksResultItemsWork_timeWork_hoursTimetableThursdayClose $close;
    */
    public $close = null;
