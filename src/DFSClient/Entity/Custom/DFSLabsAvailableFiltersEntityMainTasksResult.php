...
{    
    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultRelated_keywords $related_keywords;
    */
    public $related_keywords = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultKeyword_suggestions $keyword_suggestions;
    */
    public $keyword_suggestions = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultRanked_keywords $ranked_keywords;
    */
    public $ranked_keywords = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultKeyword_ideas $keyword_ideas;
    */
    public $keyword_ideas = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultSerp_competitors $serp_competitors;
    */
    public $serp_competitors = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultRelevant_pages $relevant_pages;
    */
    public $relevant_pages = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultSubdomains $subdomains;
    */
    public $subdomains = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultCompetitors_domain $competitors_domain;
    */
    public $competitors_domain = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultCategories_for_domain $categories_for_domain;
    */
    public $categories_for_domain = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultKeywords_for_categories $keywords_for_categories;
    */
    public $keywords_for_categories = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultDomain_intersection $domain_intersection;
    */
    public $domain_intersection = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultPage_intersection $page_intersection;
    */
    public $page_intersection = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultDomain_whois_overview $domain_whois_overview;
    */
