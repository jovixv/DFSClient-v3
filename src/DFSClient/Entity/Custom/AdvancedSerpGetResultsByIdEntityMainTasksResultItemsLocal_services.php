...
class AdvancedSerpGetResultsByIdEntityMainTasksResultItemsLocal_services
{
    ...
    /**
     * @var array|AdvancedSerpGetResultsByIdEntityMainTasksResultItemsLocal_servicesItems[];
     */
    public $items = [];

    /**
     * @var null|AdvancedSerpGetResultsByIdEntityMainTasksResultItemsLocal_servicesRectangle;
     */
