...
{    
    /**
    * @var array|BusinessInfoGetResultsByIdEntityMainTasksResultItemsDirectoryItemsWork_hoursWork_hoursTimetableSunday[] $sunday;
    */
    public $sunday = [];

    /**
    * @var array|BusinessInfoGetResultsByIdEntityMainTasksResultItemsDirectoryItemsWork_hoursWork_hoursTimetableMonday[] $monday;
    */
    public $monday = [];

    /**
    * @var array|BusinessInfoGetResultsByIdEntityMainTasksResultItemsDirectoryItemsWork_hoursWork_hoursTimetableTuesday[] $tuesday;
    */
    public $tuesday = [];

    /**
    * @var array|BusinessInfoGetResultsByIdEntityMainTasksResultItemsDirectoryItemsWork_hoursWork_hoursTimetableWednesday[] $wednesday;
    */
    public $wednesday = [];

    /**
    * @var array|BusinessInfoGetResultsByIdEntityMainTasksResultItemsDirectoryItemsWork_hoursWork_hoursTimetableThursday[] $thursday;
    */
    public $thursday = [];

    /**
    * @var array|BusinessInfoGetResultsByIdEntityMainTasksResultItemsDirectoryItemsWork_hoursWork_hoursTimetableFriday[] $friday;
    */
    public $friday = [];

    /**
    * @var array|BusinessInfoGetResultsByIdEntityMainTasksResultItemsDirectoryItemsWork_hoursWork_hoursTimetableSaturday[] $saturday;
    */
    public $saturday = [];
