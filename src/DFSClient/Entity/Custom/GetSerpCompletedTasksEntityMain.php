...
use DFSClient\Entity\Custom\GetSerpCompletedTasksEntityTasks;

class GetSerpCompletedTasksEntityMain extends \DFSClient\Models\ResponseModel 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|GetSerpCompletedTasksEntityTasks[] tasks;
    */
    public $tasks = null;        
     

	/**
	* @return \DFSClient\Entity\Custom\GetSerpCompletedTasksEntityResult|null
	*/
	public function getResultsByPostID($postID): ?\DFSClient\Entity\Custom\GetSerpCompletedTasksEntityResult {
