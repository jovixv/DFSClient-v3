...
use DFSClientV3\Entity\Custom\GoogleCompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsLocal_packClickstream_gender_distribution;
use DFSClientV3\Entity\Custom\GoogleCompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsLocal_packClickstream_age_distribution;

#[\AllowDynamicProperties]
class GoogleCompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsLocal_pack 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|GoogleCompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsLocal_packClickstream_gender_distribution $clickstream_gender_distribution;
    */
    public $clickstream_gender_distribution = null;

    /**
    * @var null|GoogleCompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsLocal_packClickstream_age_distribution $clickstream_age_distribution;
    */
