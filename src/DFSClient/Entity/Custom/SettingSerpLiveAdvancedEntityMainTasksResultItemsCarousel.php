...
{    
    ...
    */
    ...
    /**
    * @var array|SettingSerpLiveAdvancedEntityMainTasksResultItemsCarouselItems[] $items;
    */
    public $items = [];

    /**
    * @var null|SettingSerpLiveAdvancedEntityMainTasksResultItemsCarouselRectangle $rectangle;
    */
