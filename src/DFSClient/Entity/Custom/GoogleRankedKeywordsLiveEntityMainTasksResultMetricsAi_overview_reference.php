...
class GoogleRankedKeywordsLiveEntityMainTasksResultMetricsAi_overview_reference 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultMetricsAi_overview_referenceClickstream_gender_distribution $clickstream_gender_distribution;
    */
    public $clickstream_gender_distribution = null;

    /**
    * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultMetricsAi_overview_referenceClickstream_age_distribution $clickstream_age_distribution;
    */
