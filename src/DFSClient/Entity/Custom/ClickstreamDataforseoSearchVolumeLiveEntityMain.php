...
{    
    ...
    */
    ...
    /**
    * @var array|ClickstreamDataforseoSearchVolumeLiveEntityMainTasks[] $tasks;
    */
    public $tasks = [];
 

	/**
	* @return \DFSClientV3\Entity\Custom\ClickstreamDataforseoSearchVolumeLiveEntityMainTasksResult[]|null
	*/
