...
use DFSClientV3\Entity\Custom\SimilarwebLiveEntityMainTasksResultAudienceTop_categories;

#[\AllowDynamicProperties]
class SimilarwebLiveEntityMainTasksResultAudience 
{    
    /**
    ...
    */
    ...
    /**
    * @var array|SimilarwebLiveEntityMainTasksResultAudienceTop_categories[] $top_categories;
    */
