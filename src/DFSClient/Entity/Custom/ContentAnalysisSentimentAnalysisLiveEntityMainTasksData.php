...
use DFSClientV3\Entity\Custom\ContentAnalysisSentimentAnalysisLiveEntityMainTasksDataKeyword_fields;

#[\AllowDynamicProperties]
class ContentAnalysisSentimentAnalysisLiveEntityMainTasksData 
{    
    /**
    * @var null|string $api;
    */
    ...
    */
    ...
    /**
    * @var null|ContentAnalysisSentimentAnalysisLiveEntityMainTasksDataKeyword_fields $keyword_fields;
    */
