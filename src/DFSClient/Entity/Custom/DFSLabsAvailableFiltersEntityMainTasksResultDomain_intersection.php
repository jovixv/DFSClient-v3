...
{    
    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultDomain_intersectionGoogle $google;
    */
    public $google = null;

    /**
    * @var null|DFSLabsAvailableFiltersEntityMainTasksResultDomain_intersectionBing $bing;
    */
    public $bing = null;
