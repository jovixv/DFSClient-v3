...
{    
    ...
    */
    ...
    /**
    * @var null|OnPageGetPagesEntityMainTasksResultItemsRedirectFetch_timing $fetch_timing;
    */
    public $fetch_timing = null;

    /**
    * @var null|OnPageGetPagesEntityMainTasksResultItemsRedirectCache_control $cache_control;
    */
    public $cache_control = null;

    /**
    * @var null|OnPageGetPagesEntityMainTasksResultItemsRedirectChecks $checks;
    */
    public $checks = null;
