...
{    
    ...
    */
    ...
    /**
    * @var null|KeywordSuggestionsForUrlGetCompletedTasksEntityMainTasksData $data;
    */
    public $data = null;

    /**
    * @var array|KeywordSuggestionsForUrlGetCompletedTasksEntityMainTasksResult[] $result;
    */
    public $result = [];
