...
{    
    ...
    */
    ...
    /**
    * @var null|GoogleCategoriesForDomainLiveEntityMainTasksResultItemsMetricsPaidClickstream_gender_distribution $clickstream_gender_distribution;
    */
    public $clickstream_gender_distribution = null;

    /**
    * @var null|GoogleCategoriesForDomainLiveEntityMainTasksResultItemsMetricsPaidClickstream_age_distribution $clickstream_age_distribution;
    */
