...
{    
    /**
    * @var null|BusinessListingsCategoriesAggregationLiveEntityMainTasksResultItemsAggregationTop_categories $top_categories;
    */
    public $top_categories = null;

    /**
    * @var null|BusinessListingsCategoriesAggregationLiveEntityMainTasksResultItemsAggregationTop_countries $top_countries;
    */
    public $top_countries = null;

    /**
    * @var null|integer $websites_count;
    */
    ...
    */
    ...
    /**
    * @var null|BusinessListingsCategoriesAggregationLiveEntityMainTasksResultItemsAggregationTop_attributes $top_attributes;
    */
    public $top_attributes = null;

    /**
    * @var null|BusinessListingsCategoriesAggregationLiveEntityMainTasksResultItemsAggregationTop_place_topics $top_place_topics;
    */
