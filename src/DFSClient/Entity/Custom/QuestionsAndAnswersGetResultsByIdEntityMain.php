...
{    
    ...
    */
    ...
    /**
    * @var array|QuestionsAndAnswersGetResultsByIdEntityMainTasks[] $tasks;
    */
    public $tasks = [];
 

	/**
	* @return \DFSClientV3\Entity\Custom\QuestionsAndAnswersGetResultsByIdEntityMainTasksResult[]|null
	*/
