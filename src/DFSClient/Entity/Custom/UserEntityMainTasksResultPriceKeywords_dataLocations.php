...
{    
    /**
    * array|UserEntityMainTasksResultPriceKeywords_dataLocationsPriority_low[] $priority_low;
    */
    public $priority_low = [];

    /**
    * array|UserEntityMainTasksResultPriceKeywords_dataLocationsPriority_normal[] $priority_normal;
    */
    public $priority_normal = [];

    /**
    * array|UserEntityMainTasksResultPriceKeywords_dataLocationsPriority_high[] $priority_high;
    */
