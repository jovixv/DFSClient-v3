...
use DFSClient\Entity\Custom\GetSerpResultsByTaskIdEntityTasks;

class GetSerpResultsByTaskIdEntityMain extends \DFSClient\Models\ResponseModel 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|GetSerpResultsByTaskIdEntityTasks[] tasks;
    */
    public $tasks = null;        
     

	/**
	* @return \DFSClient\Entity\Custom\GetSerpResultsByTaskIdEntityResult[]|null
	*/
