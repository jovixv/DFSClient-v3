...
class GoogleRankedKeywordsLiveEntityMainTasksResultItemsRanked_serp_elementSerp_item
{
    ...
    /**
     * @var array|GoogleRankedKeywordsLiveEntityMainTasksResultItemsRanked_serp_elementSerp_itemLinks[];
     */
    public $links = [];
    ...
    /**
     * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultItemsRanked_serp_elementSerp_itemRank_changes;
     */
    public $rank_changes = null;

    /**
     * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultItemsRanked_serp_elementSerp_itemBacklinks_info;
     */
    public $backlinks_info = null;

    /**
     * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultItemsRanked_serp_elementSerp_itemRank_info;
     */
