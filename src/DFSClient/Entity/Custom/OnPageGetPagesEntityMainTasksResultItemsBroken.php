...
class OnPageGetPagesEntityMainTasksResultItemsBroken 
{    
    /**
    ...
    */
    ...
    /**
    * @var null|OnPageGetPagesEntityMainTasksResultItemsBrokenFetch_timing $fetch_timing;
    */
    public $fetch_timing = null;

    /**
    * @var null|OnPageGetPagesEntityMainTasksResultItemsBrokenCache_control $cache_control;
    */
    public $cache_control = null;

    /**
    * @var null|OnPageGetPagesEntityMainTasksResultItemsBrokenChecks $checks;
    */
    public $checks = null;
