...
{    
    ...
    */
    ...
    /**
    * @var null|GoogleKeywordIdeasLiveEntityMainTasksResultItemsClickstream_keyword_infoGender_distribution $gender_distribution;
    */
    public $gender_distribution = null;

    /**
    * @var null|GoogleKeywordIdeasLiveEntityMainTasksResultItemsClickstream_keyword_infoAge_distribution $age_distribution;
    */
    public $age_distribution = null;

    /**
    * @var array|GoogleKeywordIdeasLiveEntityMainTasksResultItemsClickstream_keyword_infoMonthly_searches[] $monthly_searches;
    */
