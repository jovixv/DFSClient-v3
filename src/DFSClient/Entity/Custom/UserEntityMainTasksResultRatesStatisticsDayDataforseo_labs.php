...
{    
    ...
    */
    ...
    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsCategories_for_domain $categories_for_domain;
    */
    public $categories_for_domain = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsCompetitors_domain $competitors_domain;
    */
    public $competitors_domain = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsDomain_intersection $domain_intersection;
    */
    public $domain_intersection = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsDomain_rank_overview $domain_rank_overview;
    */
    public $domain_rank_overview = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsKeyword_ideas $keyword_ideas;
    */
    public $keyword_ideas = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsKeywords_for_categories $keywords_for_categories;
    */
    public $keywords_for_categories = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsKeyword_suggestions $keyword_suggestions;
    */
    ...
    */
    ...
    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsRanked_domains_by_category $ranked_domains_by_category;
    */
    public $ranked_domains_by_category = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsRanked_keywords $ranked_keywords;
    */
    public $ranked_keywords = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsRelated_keywords $related_keywords;
    */
    public $related_keywords = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsRelevant_pages $relevant_pages;
    */
    public $relevant_pages = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsSerp_competitors $serp_competitors;
    */
    public $serp_competitors = null;

    /**
    * @var null|UserEntityMainTasksResultRatesStatisticsDayDataforseo_labsSubdomains $subdomains;
    */
