...
class BackLinksPageIntersectionEntityMainTasksResultItemsPage_intersectionPageIntersectionDictionaryItem
{    
    /**
    ...
    */
    public $domain_from_ip = null;
		...
		/**
		 * @var null|string $domain_from_country;
		 */
		public $domain_from_country = null;
    ...
    */
    ...
    /**
    * @var null|integer $url_to_status_code;
    */
    public $url_to_status_code = null;

		/**
		 * @var null|integer $url_to_spam_score;
		 */
		public $url_to_spam_score = null;

		/**
		 * @var null|integer $backlink_spam_score
		 */
		public $backlink_spam_score = null;
		...
		/**
		 * @var null|string $url_to_redirect_target;
		 */
		public $url_to_redirect_target = null;
