...
{    
    ...
    */
    ...
    /**
    * @var array|AdvancedSerpGetResultsByIdEntityMainTasksResultItemsAppItems[] $items;
    */
    public $items = [];

    /**
    * @var null|AdvancedSerpGetResultsByIdEntityMainTasksResultItemsAppRectangle $rectangle;
    */
