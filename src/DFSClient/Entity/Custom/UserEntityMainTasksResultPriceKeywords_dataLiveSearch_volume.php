...
{    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_dataLiveSearch_volumePriority_low priority_low;
    */
    public $priority_low = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_dataLiveSearch_volumePriority_normal priority_normal;
    */
    public $priority_normal = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceKeywords_dataLiveSearch_volumePriority_high priority_high;
    */
