...
class AdvancedSerpGetResultsByIdEntityMainTasksResult
{
    ...
    /**
     * @var null|AdvancedSerpGetResultsByIdEntityMainTasksResultRefinement_chips;
     */
