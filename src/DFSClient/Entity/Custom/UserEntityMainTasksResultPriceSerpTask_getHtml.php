...
{    
    /**
    * array|UserEntityMainTasksResultPriceSerpTask_getHtmlPriority_low[] $priority_low;
    */
    public $priority_low = [];

    /**
    * array|UserEntityMainTasksResultPriceSerpTask_getHtmlPriority_normal[] $priority_normal;
    */
    public $priority_normal = [];

    /**
    * array|UserEntityMainTasksResultPriceSerpTask_getHtmlPriority_high[] $priority_high;
    */
