...
{    
    /**
    * @var null|UserEntityMainTasksResultPriceSerpTask_getHtmlPriority_low priority_low;
    */
    public $priority_low = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceSerpTask_getHtmlPriority_normal priority_normal;
    */
    public $priority_normal = null;        
    
    /**
    * @var null|UserEntityMainTasksResultPriceSerpTask_getHtmlPriority_high priority_high;
    */
