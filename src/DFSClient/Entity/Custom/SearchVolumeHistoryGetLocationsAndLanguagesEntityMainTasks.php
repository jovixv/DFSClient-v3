...
{    
    ...
    */
    ...
    /**
    * @var null|SearchVolumeHistoryGetLocationsAndLanguagesEntityMainTasksData $data;
    */
    public $data = null;

    /**
    * @var array|SearchVolumeHistoryGetLocationsAndLanguagesEntityMainTasksResult[] $result;
    */
    public $result = [];
