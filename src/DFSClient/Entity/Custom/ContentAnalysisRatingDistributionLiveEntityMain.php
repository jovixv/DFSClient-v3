...
{    
    ...
    */
    ...
    /**
    * @var array|ContentAnalysisRatingDistributionLiveEntityMainTasks[] $tasks;
    */
    public $tasks = [];
 

	/**
	* @return \DFSClientV3\Entity\Custom\ContentAnalysisRatingDistributionLiveEntityMainTasksResult[]|null
	*/
