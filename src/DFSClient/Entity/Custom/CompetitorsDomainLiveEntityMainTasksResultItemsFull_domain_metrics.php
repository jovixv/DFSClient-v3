...
{    
    /**
    * @var null|CompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsOrganic $organic;
    */
    public $organic = null;

    /**
    * @var null|CompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsPaid $paid;
    */
    public $paid = null;
