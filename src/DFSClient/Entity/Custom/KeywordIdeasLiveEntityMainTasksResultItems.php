...
{    
    ...
    */
    ...
    /**
    * @var null|KeywordIdeasLiveEntityMainTasksResultItemsKeyword_info $keyword_info;
    */
    public $keyword_info = null;

    /**
    * @var null|KeywordIdeasLiveEntityMainTasksResultItemsImpressions_info $impressions_info;
    */
