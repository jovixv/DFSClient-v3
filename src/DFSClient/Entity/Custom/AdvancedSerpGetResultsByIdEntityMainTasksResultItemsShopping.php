...
{    
    ...
    */
    ...
    /**
    * @var array|AdvancedSerpGetResultsByIdEntityMainTasksResultItemsShoppingItems[] $items;
    */
    public $items = [];

    /**
    * @var null|AdvancedSerpGetResultsByIdEntityMainTasksResultItemsShoppingRectangle $rectangle;
    */
