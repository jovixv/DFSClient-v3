...
{    
    ...
    */
    ...
    /**
    * @var null|BingPageIntersectionLiveEntityMainTasksResultItemsKeyword_dataKeyword_info $keyword_info;
    */
    public $keyword_info = null;

    /**
    * @var null|BingPageIntersectionLiveEntityMainTasksResultItemsKeyword_dataSerp_info $serp_info;
    */
