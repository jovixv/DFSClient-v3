...
{    
    /**
    * @var null|BingRankedKeywordsLiveEntityMainTasksResultMetrics_absoluteOrganic $organic;
    */
    public $organic = null;

    /**
    * @var null|BingRankedKeywordsLiveEntityMainTasksResultMetrics_absolutePaid $paid;
    */
    public $paid = null;

    /**
    * @var null|BingRankedKeywordsLiveEntityMainTasksResultMetrics_absoluteFeatured_snippet $featured_snippet;
    */
    public $featured_snippet = null;

    /**
    * @var null|BingRankedKeywordsLiveEntityMainTasksResultMetrics_absoluteLocal_pack $local_pack;
    */
