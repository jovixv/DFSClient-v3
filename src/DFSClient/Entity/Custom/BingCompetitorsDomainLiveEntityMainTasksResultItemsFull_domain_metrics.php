...
{    
    /**
    * @var null|BingCompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsOrganic $organic;
    */
    public $organic = null;

    /**
    * @var null|BingCompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsPaid $paid;
    */
    public $paid = null;

    /**
    * @var null|BingCompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsLocal_pack $local_pack;
    */
    public $local_pack = null;

    /**
    * @var null|BingCompetitorsDomainLiveEntityMainTasksResultItemsFull_domain_metricsFeatured_snippet $featured_snippet;
    */
