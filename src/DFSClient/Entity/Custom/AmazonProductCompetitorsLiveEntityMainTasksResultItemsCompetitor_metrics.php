...
{    
    /**
    * @var null|AmazonProductCompetitorsLiveEntityMainTasksResultItemsCompetitor_metricsAmazon_serp $amazon_serp;
    */
    public $amazon_serp = null;

    /**
    * @var null|AmazonProductCompetitorsLiveEntityMainTasksResultItemsCompetitor_metricsAmazon_paid $amazon_paid;
    */
