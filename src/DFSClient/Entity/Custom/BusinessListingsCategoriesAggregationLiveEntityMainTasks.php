...
{    
    ...
    */
    ...
    /**
    * @var null|BusinessListingsCategoriesAggregationLiveEntityMainTasksData $data;
    */
    public $data = null;

    /**
    * @var array|BusinessListingsCategoriesAggregationLiveEntityMainTasksResult[] $result;
    */
    public $result = [];
