...
{    
    ...
    */
    ...
    /**
    * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultItemsKeyword_dataKeyword_info_normalized_with_bing $keyword_info_normalized_with_bing;
    */
    public $keyword_info_normalized_with_bing = null;

    /**
    * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultItemsKeyword_dataKeyword_info_normalized_with_clickstream $keyword_info_normalized_with_clickstream;
    */
    ...
    */
    ...
    /**
    * @var null|GoogleRankedKeywordsLiveEntityMainTasksResultItemsKeyword_dataSerp_info $serp_info;
    */
