...
{    
    /**
    * @var null|BusinessInfoGetResultsByIdEntityMainTasksResultItemsWork_timeWork_hoursTimetableSunday $sunday;
    */
    public $sunday = null;
    ...
    */
    ...
    /**
    * @var null|BusinessInfoGetResultsByIdEntityMainTasksResultItemsWork_timeWork_hoursTimetableTuesday $tuesday;
    */
    public $tuesday = null;

    /**
    * @var null|BusinessInfoGetResultsByIdEntityMainTasksResultItemsWork_timeWork_hoursTimetableWednesday $wednesday;
    */
    public $wednesday = null;

    /**
    * @var null|BusinessInfoGetResultsByIdEntityMainTasksResultItemsWork_timeWork_hoursTimetableThursday $thursday;
    */
    public $thursday = null;

    /**
    * @var null|BusinessInfoGetResultsByIdEntityMainTasksResultItemsWork_timeWork_hoursTimetableFriday $friday;
    */
    public $friday = null;
