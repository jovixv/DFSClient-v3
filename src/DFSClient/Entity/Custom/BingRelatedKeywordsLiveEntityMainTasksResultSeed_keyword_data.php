...
{    
    ...
    */
    ...
    /**
    * @var null|BingRelatedKeywordsLiveEntityMainTasksResultSeed_keyword_dataKeyword_info $keyword_info;
    */
    public $keyword_info = null;

    /**
    * @var null|BingRelatedKeywordsLiveEntityMainTasksResultSeed_keyword_dataSerp_info $serp_info;
    */
