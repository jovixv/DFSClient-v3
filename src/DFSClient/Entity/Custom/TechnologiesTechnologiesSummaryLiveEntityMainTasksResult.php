...
{    
    /**
    * @var null|TechnologiesTechnologiesSummaryLiveEntityMainTasksResultCountries $countries;
    */
    public $countries = null;

    /**
    * @var null|TechnologiesTechnologiesSummaryLiveEntityMainTasksResultLanguages $languages;
    */
    public $languages = null;

    /**
    * @var null|TechnologiesTechnologiesSummaryLiveEntityMainTasksResultContent_languages $content_languages;
    */
    public $content_languages = null;

    /**
    * @var null|TechnologiesTechnologiesSummaryLiveEntityMainTasksResultKeywords $keywords;
    */
