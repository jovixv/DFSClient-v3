...
use DFSClientV3\Entity\Custom\LlmMentionsTopPagesLiveEntityMainTasksDataTarget;

#[\AllowDynamicProperties]
class LlmMentionsTopPagesLiveEntityMainTasksData 
{    
    /**
    * @var null|string $api;
    */
    ...
    */
    ...
    /**
    * @var array|LlmMentionsTopPagesLiveEntityMainTasksDataTarget[] $target;
    */
    public $target = [];
