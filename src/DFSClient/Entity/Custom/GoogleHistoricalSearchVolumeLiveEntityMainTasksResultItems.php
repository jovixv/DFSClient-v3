...
{    
    ...
    */
    ...
    /**
    * @var null|GoogleHistoricalSearchVolumeLiveEntityMainTasksResultItemsKeyword_info_normalized_with_bing $keyword_info_normalized_with_bing;
    */
    public $keyword_info_normalized_with_bing = null;

    /**
    * @var null|GoogleHistoricalSearchVolumeLiveEntityMainTasksResultItemsKeyword_info_normalized_with_clickstream $keyword_info_normalized_with_clickstream;
    */
    ...
    */
    ...
    /**
    * @var null|GoogleHistoricalSearchVolumeLiveEntityMainTasksResultItemsAvg_backlinks_info $avg_backlinks_info;
    */
