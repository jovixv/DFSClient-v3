...
class AdvancedSerpGetResultsByIdEntityMainTasksResultItemsGoogle_finance_quote
{
	/**
	...
	/**
	 * @var null|AdvancedSerpGetResultsByIdEntityMainTasksResultItemsGoogle_finance_quoteGraph_items[] $graph_items;
	 */
	public $graph_items = null;
