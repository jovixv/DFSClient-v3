...
class OnPageInstantPagesEntityMainTasksResultItemsHtml
{    
    /**
    ...
    */
    ...
    /**
    * @var null|OnPageInstantPagesEntityMainTasksResultItemsHtmlMeta $meta;
    */
    public $meta = null;

    /**
    * @var null|OnPageInstantPagesEntityMainTasksResultItemsHtmlPage_timing $page_timing;
    */
    ...
    */
    ...
    /**
    * @var null|OnPageInstantPagesEntityMainTasksResultItemsHtmlCache_control $cache_control;
    */
    public $cache_control = null;

    /**
    * @var null|OnPageInstantPagesEntityMainTasksResultItemsHtmlChecks $checks;
    */
    public $checks = null;
